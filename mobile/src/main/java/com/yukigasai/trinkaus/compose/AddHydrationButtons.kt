package com.yukigasai.trinkaus.compose
...
import com.yukigasai.trinkaus.HydrationHelper
import com.yukigasai.trinkaus.R
import com.yukigasai.trinkaus.getVolumeStringWithUnit
import com.yukigasai.trinkaus.isMetric
...
@Composable
fun AddHydrationButtons(udpateHydrationlevel: (newValue: Double) -> Unit) {
            ...
            TooltipBox(
                ...
                Button(onClick = {
                    scope.launch {
                        ...
                        udpateHydrationlevel(HydrationHelper.readHydrationLevel(context))
                    }
                }) {
                    Icon(
